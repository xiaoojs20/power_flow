function run_pf_matlab_n10()
    % Run power flow for multiple scenarios in MATPOWER (10-node system)
    addpath(pwd);
    ...
    for m = 1:length(mode_names)
        ...
        for i = 1:length(names)
            ...
            Ps = scenarios.(name);
            try
                mpc = build_case_lfreq_n10(Ps, mode_val);
        ...
        for scale = 0.1:0.1:1.5
            ...
            try
                mpc_s = build_case_lfreq_n10(Ps_sweep, mode_val);
